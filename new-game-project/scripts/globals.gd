...
STRBURST, LSRBEAM, SWEEPER, MEDIC1, GUNNER2, BURST1, BURST2, SLAMMER} # ENUM ids for each upgrade.
 ...
 # ENUM IDS for all attributes that can be upgraded
...
HEALING_ORBS, HEALING_ORBS_AMOUNT, HEALING_ORBS_CHANCE, BURST_AMOUNT, BURST_DELAY}

# Healing orbs are managed here for easy accesss
...
signal upgrade_screen # Summons the upgrade screen.
 ...
 # The pool of common upgrades that the player starts with
var potential_common_upgrades_init_value := [
	...
	increase damage falloff, decrease damage.",
	...
	"description": "Increase bullet velocity. Bullets have a chance to crit for 3x damage.",
	"icon_path": "res://assets/icons/Sharpshooter_Icon.png"},
	
	{"id": upgrade_ids.SHARPSHT2, "name": "Sharpshooter II", "rarity": "Common",
	"description": "Increase crit damage by 50%. Increase crit chance by 10%",
	"icon_path": "res://assets/icons/Sharpshooter_Icon.png"},
	...
	{"id": upgrade_ids.COMMANDO2, "name": "Commando II", "rarity": "Common", 
	"description": "Dashing reloads half your magazine.",
	"icon_path": "res://assets/icons/Commando_Icon.png"},
	
	{"id": upgrade_ids.MEDIC1,"name": "Medic I", "rarity": "Common", 
	"description": "Increased Max HP. Enemies have a chance to drop healing orbs.",
...
var potential_common_upgrades := [] # Initialised to the above variable on game start, 
# taken from so the player can't get two upgrades twice.


var potential_rare_upgrades_init_value := [ # Ditto but rare
	{"id": upgrade_ids.STRBURST, "name": "Starburst", "rarity": "Rare",
	"description": "Spread becomes 360 degrees. Increase pellets per shot. \
	Reduce damage. Bullets now home.",
	...
	"description": "Vastly increaes firerate but drastically reduces damage.\
...
func play_sound(sound: AudioStream) -> void: # Generic sound player.
	#Instantiates an audio stream then destroys it once its done.
